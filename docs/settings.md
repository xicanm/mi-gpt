...
| **speaker**                  |                                                                                                                                                      |                                                                  |
| `userId`                     | [小米 ID](https://account.xiaomi.com/fe/service/account/profile)（注意：不是手机号或邮箱）                                                           | `"454515"`                                                    |
| `password`                   | 账户密码                                                                                                                                             | `"7856297xz"`                                                       |
| `did`                        | 小爱音箱 ID 或名称                                                                                                                                   | `"xiaomi智能家庭屏 Pro8"`                                                 |
...
| `callAIKeywords`             | 当消息以关键词开头时，会调用 AI 来响应用户消息                                                                                                       | `["豆包", "傻妞"]`                                                 |
| `wakeUpKeywords`             | 当消息以关键词开头时，会进入 AI 唤醒状态                                                                                                             | `["召唤豆包", "打开傻妞"]`                                       |
| `exitKeywords`               | 当消息以关键词开头时，会退出 AI 唤醒状态                                                                                                             | `["退出豆包", "关闭傻妞"]`                                       |
| `onEnterAI`                  | 进入 AI 模式的欢迎语                                                                                                                                 | `["你好，我是豆包，很高兴认识你"]`                               |
| `onExitAI`                   | 退出 AI 模式的提示语                                                                                                                                 | `["豆包已退出"]`                                                 |
...
| ---------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| **OpenAI**             |                                                                                             |                                                |
| `OPENAI_API_KEY`       | OpenAI API 密钥                                                                             | `豆包`                                       |
| `OPENAI_MODEL`         | 使用的 OpenAI 模型                                                                          | `豆包`                                       |
| `OPENAI_BASE_URL`      | 可选，OpenAI API BaseURL                                                                    | `3e2a4687-e184-486f-b554-3e56d322490a`                    |
